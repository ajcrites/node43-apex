        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 3;
              _context2.next = 6;
              return _bluebird.Promise.using(sql.getSqlConnection(pool), function () {
                  ...
                  return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return _bluebird.Promise.resolve(fn(event, connection, context, callback));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 2;
              _context3.next = 5;
              return _bluebird.Promise.resolve(fn(event, context, callback));
            ...
            case 8:
              ...
              sentryClient.captureException(_context3.t0);
              throw _context3.t0;
